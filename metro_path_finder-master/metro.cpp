	...
	do
	{
		...
		switch(dec)
		{
			case 1:
				do
					{
						cout<<"#----------CHOOSE COLOUR OF LINE FOR METRO STATION----------#\n";
						...
						cout<<"Do you wish to check for any other list of station\n";
						cin>>ch;
					}while(ch=='Y'||ch=='y');
					break;
			case 2:
					cout<<"List OF TOURIST PLACES\n";
			...
			case 6:
					do
					{
						...
						cout<<"Do you wish to check for another path\n";
						cin>>ch;
					}while(ch=='Y'||ch=='y');
					break;
			case 7:
